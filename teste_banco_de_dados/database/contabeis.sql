...
/*----------------IMPORTANDO CSV----------------*/
LOAD DATA LOCAL INFILE '2023/1T2023.csv' -- inserir dados do csv nas colunas
...
(DATA, REG_ANS, CD_CONTA_CONTABIL, DESCRICAO, VL_SALDO_INICIAL, VL_SALDO_FINAL) -- mapamento direto das colunas
